...
},{"./lib/util":11,"./lib/validates":12,"./lib/validator":13}],11:[function(require,module,exports){
/**
 * Utilties
 */
...
},{"./util":11,"./validates":12}],14:[function(require,module,exports){
var _ = require('../util')
...
},{"../compiler":24,"../util":75,"_process":1}],20:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
...
},{"./config":26,"./util":75,"_process":1}],21:[function(require,module,exports){
/**
...
},{"../config":26,"../directives/prop":42,"../parsers/path":65,"../parsers/text":67,"../util":75,"_process":1}],23:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../config":26,"../directives/component":31,"../parsers/directive":63,"../parsers/template":66,"../parsers/text":67,"../util":75,"./compile-props":22,"_process":1}],24:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":26,"../parsers/template":66,"../util":75,"_process":1}],26:[function(require,module,exports){
module.exports = {
...
},{"./config":26,"./parsers/expression":64,"./parsers/text":67,"./util":75,"./watcher":79,"_process":1}],28:[function(require,module,exports){
// xlink
...
},{"../config":26,"../parsers/template":66,"../util":75,"_process":1}],32:[function(require,module,exports){
module.exports = {
...
},{"../cache":21,"../compiler":24,"../parsers/template":66,"../transition":68,"../util":75,"_process":1}],35:[function(require,module,exports){
...
},{"../../util":75,"./checkbox":36,"./radio":38,"./select":39,"./text":40,"_process":1}],38:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../parsers/directive":63,"../../util":75,"../../watcher":79,"_process":1}],40:[function(require,module,exports){
var _ = require('../../util')
...
},{"../util":75,"_process":1}],42:[function(require,module,exports){
...
},{"../util":75,"_process":1}],44:[function(require,module,exports){
(function (process){
var _ = require('../util')
var config = require('../config')
...
},{"../compiler":24,"../config":26,"../parsers/expression":64,"../parsers/template":66,"../parsers/text":67,"../util":75,"_process":1}],45:[function(require,module,exports){
var transition = require('../transition')
...
},{"../cache":21,"../compiler":24,"../directives/if":34,"../parsers/template":66,"../parsers/text":67,"../util":75,"_process":1}],52:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parsers/path')
...
},{"../util":75,"_process":1}],56:[function(require,module,exports){
...
},{"../util":75,"_process":1}],58:[function(require,module,exports){
(function (process){
var _ = require('../util')
var compiler = require('../compiler')
...
},{"../compiler":24,"../observer":61,"../observer/dep":60,"../util":75,"../watcher":79,"_process":1}],59:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":21,"../util":75,"./path":65,"_process":1}],65:[function(require,module,exports){
(function (process){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":21,"../util":75,"_process":1}],66:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"./index":75,"_process":1}],72:[function(require,module,exports){
(function (process){
/**
...
},{"../config":26,"_process":1}],73:[function(require,module,exports){
(function (process){
var _ = require('./index')
var config = require('../config')
...
},{"../config":26,"./index":75,"_process":1}],74:[function(require,module,exports){
...
},{"../config":26,"./index":75,"_process":1}],78:[function(require,module,exports){
var _ = require('./util')
var extend = _.extend
...
},{"./batcher":20,"./config":26,"./observer/dep":60,"./parsers/expression":64,"./util":75,"_process":1}],80:[function(require,module,exports){
'use strict';
...
new Vue({
  ...
  */
		...
		$('#search').typeahead({
			...
			templates: {
				suggestion: function suggestion(ersContacts) {
					return '<div class="uk-text">' + '<h3 class="uk-title">' + ersContacts.title + ' ' + ersContacts.first_name + ' ' + ersContacts.last_name + '</h3><h4>' + ersContacts.email + '</h4><p class="uk-text-muted "><i class="uk-icon-map-marker"></i> ' + ersContacts.city + ' | ' + ersContacts.country + '</p>' + '</div>';
				}
			},
			source: ersContacts
	...
	methods: {
		fetchInvitedReviewers: function fetchInvitedReviewers() {
		...
		onSubmitForm: function onSubmitForm(e) {
			...
			if (!this.quantity <= 0) {
				this.$http.post('api/store', reviewer, function (success) {
...
},{"vue":78,"vue-resource":3,"vue-validator":10}]},{},[80]);
